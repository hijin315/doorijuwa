...
export default Main = ({navigation}) => {
  const area = '성북동'
  const restURL = "http://store.naver.com/sogum/api/businesses?start=1&display=20&query="+area+"+맛집&sortingOrder=reviewCount";
  const cafeURL = "http://store.naver.com/sogum/api/businesses?start=1&display=20&query="+area+"+카페&sortingOrder=reviewCount";
  const playURL = "http://store.naver.com/sogum/api/businesses?start=1&display=20&query="+area+"+놀거리&sortingOrder=reviewCount";
